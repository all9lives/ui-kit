...
/* Fix react-native@0.48 jest incompatible */
const mockNativeModules = {
  ...
  PushNotificationManager: {
    ...
    getApplicationIconBadgeNumber: jest.fn(callback => process.nextTick(() => callback(0))), // eslint-disable-line
    ...
    checkPermissions: jest.fn(callback => process.nextTick(() => callback({alert: true, badge: true, sound: true}))), // eslint-disable-line
